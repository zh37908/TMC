...
def get_args(parser):
    ...
    parser.add_argument("--data_path", type=str, default="/home/hzhaobi/Multired/conc_data/")
    ...
    parser.add_argument("--savedir", type=str, default="./savepath/TMC_base/sunrgbd/")
...
def cli_main():
    parser = argparse.ArgumentParser(description="Train TMC_base_channel on SUNRGBD")
    get_args(parser)
