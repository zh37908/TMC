...
# Example 8: Train ETMC with SNR model (SNR-aware receiver)
echo "Example 8: ETMC SNR Model - SNR-aware receiver with concat method"
echo "Command:"
echo "$PYTHON $ROOT/TMC/ETMC_TPAMI/train_ETMC_channel_snr_nyud2.py \\"
echo "  --channel_mode snr_model \\"
echo "  --channel_snr 15.0 \\"
echo "  --snr_input_method concat \\"
echo "  --snr_embed_dim 64 \\"
echo "  --pretrain DeCUR \\"
echo "  --data_path /home/hzhaobi/Multired/nyud2 \\"
echo "  --n_classes 10 \\"
echo "  --savedir /home/hzhaobi/Multired/savepath/ETMC_channel_snr/nyud/DeCUR/concat/snr15/run1 \\"
echo "  --name train_ETMC_channel_snr_nyud_DeCUR_concat_snr15_run1 \\"
echo "  --seed 1"
echo ""

# Example 9: Run comprehensive SNR model experiments
echo "Example 9: Comprehensive SNR Model Experiments (all methods and pretrains)"
echo "Command:"
echo "bash $ROOT/TMC/ETMC_TPAMI/run_etmc_channel_snr_experiments.sh"
echo ""

echo "=== Key Parameters ==="
echo "--channel_mode: 'static', 'dynamic', or 'snr_model'"
echo "--channel_snr: Fixed SNR value for static/snr_model mode (e.g., 20.0)"
echo "--snr_min/--snr_max: SNR range for dynamic mode (e.g., 0.0 to 20.0)"
echo "--snr_input_method: SNR input method for snr_model ('concat', 'add', 'mlp')"
echo "--snr_embed_dim: Dimension of SNR embedding (default: 64)"
