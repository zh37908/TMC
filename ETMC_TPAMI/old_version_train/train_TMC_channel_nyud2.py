...
from models.TMC import TMC_channel, ce_loss
...
def get_args(parser):
    ...
    parser.add_argument("--name", type=str, default="TMC_channel")
    parser.add_argument("--num_image_embeds", type=int, default=1)
    parser.add_argument("--patience", type=int, default=20)
    parser.add_argument("--savedir", type=str, default="./savepath/TMC_channel/nyud/")
...
def train(args):
    ...
    model = TMC_channel(args).cuda()

    # optional: load pretrained backbones to encoders (truncated to trunk)
...
def cli_main():
    parser = argparse.ArgumentParser(description="Train TMC_channel Model")
    get_args(parser)
