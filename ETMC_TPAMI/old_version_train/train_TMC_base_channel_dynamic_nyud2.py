...
from models.TMC import TMC_base_channel_dynamic
...
def get_args(parser):
    ...
    parser.add_argument("--name", type=str, default="TMCBase_channel_dynamic")
    parser.add_argument("--num_image_embeds", type=int, default=1)
    parser.add_argument("--patience", type=int, default=20)
    parser.add_argument("--savedir", type=str, default="./savepath/TMCBase_channel_dynamic/nyud/")
...
def train(args):
    ...
    model = TMC_base_channel_dynamic(args).cuda()
...
def cli_main():
    parser = argparse.ArgumentParser(description="Train TMC Base Channel Model (Dynamic SNR)")
    get_args(parser)
