...
def get_args(parser):
    ...
    parser.add_argument("--savedir", type=str, default="./savepath/ETMC_channel_snr/nyud/")
...
def cli_main():
    parser = argparse.ArgumentParser(description="Train ETMC with channel (static/dynamic/snr_model)")
    get_args(parser)
