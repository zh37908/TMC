...
# ETMC Channel Dynamic Pretrain Experiments
# Run ETMC dynamic experiments with different pretraining methods
...
echo "=== Starting ETMC Channel Dynamic Pretrain Experiments ==="
echo "Python: $PYTHON"
echo "Root: $ROOT"
...
echo "=== All ETMC Channel Dynamic Pretrain Experiments Completed ==="
