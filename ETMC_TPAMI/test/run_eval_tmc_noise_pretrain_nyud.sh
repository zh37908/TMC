...
TESTER="$ROOT/TMC/ETMC_TPAMI/test/test_TMC_retransmit_nyud.py"
# SAVEDIR="$ROOT/savepath/TMC/nyud/original/Adam/pretrain_TMC/ReleasedVersion"
...
OUT_CSV="$ROOT/TMC/ETMC_TPAMI/test/results_tmc_channel_snr_noise_DeCUR_Adam_nyud.csv"
