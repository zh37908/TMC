...
TESTER="$ROOT/TMC/ETMC_TPAMI/test/test_TMC_base_channel_sunrgbd.py"
SAVEDIR="/home/hzhaobi/Multired/savepath/TMC_base/sunrgbd/ReleasedVersion"
DATAPATH="/home/hzhaobi/Multired/conc_data"

VIEWS=(rgb depth)
POWERS=(1 10 100)

OUT_CSV="$ROOT/TMC/ETMC_TPAMI/test/results_tmc_base_noise_sunrgbd.csv"
