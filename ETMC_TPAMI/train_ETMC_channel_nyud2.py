...
def get_args(parser):
    ...
    parser.add_argument("--savedir", type=str, default="./savepath/ETMC_channel/nyud/")
...
def cli_main():
    parser = argparse.ArgumentParser(description="Train ETMC with channel (static/dynamic)")
    get_args(parser)
